...
class Checks
  ...
  def __check_git_version
    ...
    if Regexp.last_match(1) && Version.new(Regexp.last_match(1)) < Version.new("1.7.10") then <<-EOS.undent
  ...
  def check_for_bad_python_symlink
    ...
    unless Regexp.last_match(1) == "2" then <<-EOS.undent
